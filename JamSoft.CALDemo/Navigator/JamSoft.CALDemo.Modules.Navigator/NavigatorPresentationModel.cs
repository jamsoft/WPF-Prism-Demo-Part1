...
namespace JamSoft.CALDemo.Modules.Navigator
{
    ...
    public class NavigatorPresentationModel : INavigatorPresentationModel
    {
        ...
        /// <summary>
        /// Handles the ItemChangeRequest event of the view control.
        /// </summary>
        /// <param name="sender">
        /// The source of the event.
        /// </param>
        /// <param name="e">
        /// The <see cref="PageEventArgs"/> instance containing the event data.
        /// </param>
